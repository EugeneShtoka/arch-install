...
$SCRIPTS_PATH/gdrive-sync.sh $MUSIC_PATH $GDRIVE_NAME:$MUSIC_GDRIVE_PATH
$SCRIPTS_PATH/gdrive-sync.sh $DOCUMENTS_PATH $GDRIVE_NAME:$DOCUMENTS_GDRIVE_PATH

# sleep 10
$SCRIPTS_PATH/custom-scripts-auto-sync.sh &
$SCRIPTS_PATH/gdrive-auto-sync.sh $LIBRARY_PATH $GDRIVE_NAME:$LIBRARY_GDRIVE_PATH &
$SCRIPTS_PATH/sync-gdrive.sh $MUSIC_PATH $GDRIVE_NAME:$MUSIC_GDRIVE_PATH
$SCRIPTS_PATH/sync-gdrive.sh $DOCUMENTS_PATH $GDRIVE_NAME:$DOCUMENTS_GDRIVE_PATH
