...
yes | sudo pacman -S curl zsh inotify-tools thunar rofi adobe-source-code-pro-fonts bluez bluez-utils brightnessctl jre17-openjdk dbeaver postgresql docker-compose gnome-keyring bitwarden-cli jq python-packaging gvfs p7zip foliate
