...
yes | sudo pacman -S curl zsh inotify-tools thunar rofi adapta-gtk-theme arc-gtk-theme adobe-source-code-pro-fonts bluez bluez-utils brightnessctl jre17-openjdk dbeaver upower postgresql docker-compose gnome-keyring bitwarden-cli jq python-packaging gvfs p
