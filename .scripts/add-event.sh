...
DATE=`date`
BODY='{"contents": [{"parts":[{"text": "Your role is personal assistant. Today is '$DATE' Translate '$1' to english, analyze for expected finish time and prepare json consisting of SUMMARY, LOCATION, DTSTART YYYYMMDDTHHMMSS, DTEND YYYYMMDDTHHMMSS. Timezone is Asia/Jerusalem. Return json only"}]}]}'
