...
inotifywait -q -m -e DELETE,CLOSE_WRITE,MOVED_TO,MOVED_FROM $HOME/.zshrc $HOME/.env $HOME/.config/i3 $HOME/.config/systemd/user $HOME/.gitignore $SCRIPTS_PATH $SERVICES_PATH | while read DIR EVENT FILE
do
