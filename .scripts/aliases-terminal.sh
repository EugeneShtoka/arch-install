...
alias tm-db-pass='aws sso login && AWS_REGION=us-east-2  aws secretsmanager get-secret-value --secret-id 'rds!db-63c263e4-a52a-4bd0-9aed-28bef7b293f0' --query SecretString --output text | jq .password'
